...
export function useExtensionMessages(
  ...
  useEffect(() => {
    ...
    // Buffer static agents (database-sourced) until layout is loaded
    let pendingStaticAgents: Array<{
      id: number;
      name: string;
      seatUid: string;
      isWorking: boolean;
    ...
    const handler = (e: MessageEvent) => {
      ...
      } else if (msg.type === 'staticAgentsLoaded') {
        // Database-sourced characters: place working people at PCs, idle at benches
